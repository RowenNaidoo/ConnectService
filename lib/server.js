...
router.get('/related-accounts', function (request, response) {
    var result = request.query.relationType ? (0, _service.getNominees)(request.query.qffMemberId, request.query.relationType) : (0, _service.getNomineesByQffNo)(request.query.qffMemberId);
