...
router.get('/related-accounts', function (request, response) {
    var result = request.query.connectionType ? (0, _service.getNominees)(request.query.qffNo, request.query.connectionType) : (0, _service.getNomineesByQffNo)(request.query.qffNo);
